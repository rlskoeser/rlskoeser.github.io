...
At least some of these presentations will eventually be posted on the [OpenMinted blog](http://openminted.eu/blog/); please refer there for accurate numbers, since my notes are certainly inaccurate in places.
...
- DPLA is the major content aggregator in the U.S.; is text and data mining on their radar, or are they only metadata only?
