...
{% include figure.html src="/images/posts/networking-belfast/clark_hubs.png" caption="Figure 1. Graph of relationships inferred from Heather Clark’s Ulster Renaissance. Nodes are sized by degree and colored by hub score. The writing workshop is the strongest hub; the trio of large nodes represent Michael Longley, Derek Mahon, and Seamus Heaney." class="callout-left halfwidth" %}

{% include figure.html src="/images/posts/networking-belfast/prelim_degree_hub.png" caption="Figure 2. Relationship graph based on preliminary correspondence data, sized and colored as in figure 1. Based on this data, the writing workshop does not function as a hub at all, and Paul Muldoon becomes the largest node." class="callout-left halfwidth noclear" %}
